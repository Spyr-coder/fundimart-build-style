    ...
    try {
      if (registrationType === "buyer") {
        ...
        await registerSeller(
          ...
          data['hardware-name'],
          data['location'],
          data['firm-email'] || data['seller-email']
        );
          ...
          <CardContent>
            ...
            <Tabs defaultValue={["signup", "register"].includes(searchParams.get("tab") ?? "") ? "register" : "login"} className="w-full">
              ...
              <TabsContent value="register">
                ...
                {/* Seller Registration */}
                {registrationType === "seller" && (
                  <form onSubmit={handleInitiateRegister} className="space-y-4 max-h-[28rem] overflow-y-auto pr-2">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          name="firm-email"
                          type="email"
                          placeholder="store@hardware.com"
                          className="pl-10"
                        />
                      </div>
                    </div>
